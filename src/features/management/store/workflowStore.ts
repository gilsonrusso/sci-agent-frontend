...
const MOCK_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    subSections: [{ id: 's1', name: 'Full Draft', status: 'DONE', wordCount: 4500 }],
...
export const useWorkflowStore = create<WorkflowState>((set) => ({
  ...
  moveArticleStage: (articleId, newStage) =>
    set((state) => ({
  ...
  requestApproval: (articleId, targetStage) =>
    set((state) => {
